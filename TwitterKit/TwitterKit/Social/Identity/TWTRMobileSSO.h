...
/**
 *  Determines if the url sent from the calling application is valid.
 *
 *  Returns YES if the url is Twitter sanctioned, NO otherwise.
 */
- (BOOL)isSSOWithURL:(NSURL *)url;

/**
 *  Determines if the url sent from the web is valid.
 *
 *  Returns YES if the url is Twitter sanctioned, NO otherwise.
 */
